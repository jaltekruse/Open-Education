...
<select multiple="multiple" name="colleagues_sharing[]" class="chosen_dropdown" style="width:350px;" data-placeholder="Choose colleagues">
<?php foreach ( $colleagues as $colleague){ ?>
<option  value="<?php echo $colleague["user_id"]."\">".$colleague['first_name']." ".$colleague['last_name']?></option>
<?php } ?>
</select>
</form>
